...
<h7 class="teal-text" >Date and time: <fmt:formatDate value="${lastMeeting.started}" pattern="yyyy-MM-dd HH:mm:ss" /></h7>
<br>
<h7 class="teal-text" >Duration:      ${lastMeeting.duration}</h7>
